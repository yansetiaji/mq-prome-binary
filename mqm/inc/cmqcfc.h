 ...
 #define MQCMD_INTER_Q_MGR_STATUS       218
 #define MQCMD_INTER_Q_MGR_BALANCE      219
 #define MQCMD_INQUIRE_APPL_STATUS      220
 ...
 #define MQRCCF_PS_REQUIRED_MQUC        3383
 #define MQRCCF_STREAMQ_DEST_NOT_SUPP   3384
 #define MQRCCF_STREAMQ_DEST_CONFLICT   3385
 #define MQRCCF_STREAMQ_NOT_SUPPORTED   3386
 #define MQRCCF_STREAMQ_CONFLICT        3387
 #define MQRCCF_INCOMPATIBLE_QM_IN_QSG  3389
 ...
 #define MQRCCF_KWD_VALUE_WRONG_TYPE    4096
 #define MQRCCF_APPL_STATUS_NOT_FOUND   4097
 #define MQRCCF_NHA_NOT_AVAILABLE       4098
 #define MQRCCF_Q_MGR_STATUS_NOT_FOUND  4099
 ...
 #define MQ_HOST_NAME_LENGTH            256
 ...
 #define MQBACF_REQUEST_ID              7036
 #define MQBACF_PROPERTIES_DATA         7037
 #define MQBACF_CONN_TAG                7038
 #define MQBACF_MQBNO_STRUCT            7039
 #define MQBACF_LAST_USED               7039
 ...
 #define MQIACF_SYSP_SMF_STAT_TIME_MINS 1199
 ...
 #define MQIACF_MOVABLE_APPL_COUNT      1424
 #define MQIACF_APPL_INFO_ATTRS         1425
 #define MQIACF_APPL_MOVABLE            1426
 #define MQIACF_REMOTE_QMGR_ACTIVE      1427
 #define MQIACF_APPL_INFO_TYPE          1428
 #define MQIACF_APPL_INFO_APPL          1429
 #define MQIACF_APPL_INFO_QMGR          1430
 #define MQIACF_APPL_INFO_LOCAL         1431
 #define MQIACF_APPL_IMMOVABLE_COUNT    1432
 #define MQIACF_BALANCED                1433
 #define MQIACF_BALSTATE                1434
 #define MQIACF_APPL_IMMOVABLE_REASON   1435
 #define MQIACF_DS_ENCRYPTED            1436
 #define MQIACF_CUR_Q_FILE_SIZE         1437
 #define MQIACF_CUR_MAX_FILE_SIZE       1438
 #define MQIACF_BALANCING_TYPE          1439
 #define MQIACF_BALANCING_OPTIONS       1440
 #define MQIACF_BALANCING_TIMEOUT       1441
 #define MQIACF_SYSP_SMF_STAT_TIME_SECS 1442
 #define MQIACF_SYSP_SMF_ACCT_TIME_MINS 1443
 #define MQIACF_SYSP_SMF_ACCT_TIME_SECS 1444
 #define MQIACF_Q_MGR_STATUS_INFO_TYPE  1445
 #define MQIACF_Q_MGR_STATUS_INFO_Q_MGR 1446
 #define MQIACF_Q_MGR_STATUS_INFO_NHA   1447
 #define MQIACF_AUTO_CLUSTER_TYPE       1448
 #define MQIACF_DATA_FS_IN_USE          1449
 #define MQIACF_DATA_FS_SIZE            1450
 #define MQIACF_LOG_EXTENT_SIZE         1451
 #define MQIACF_LOG_FS_IN_USE           1452
 #define MQIACF_LOG_FS_SIZE             1453
 #define MQIACF_LOG_PRIMARIES           1454
 #define MQIACF_LOG_SECONDARIES         1455
 #define MQIACF_LOG_TYPE                1456
 #define MQIACF_NHA_INSTANCE_ACTV_CONNS 1457
 #define MQIACF_NHA_INSTANCE_BACKLOG    1458
 #define MQIACF_NHA_INSTANCE_IN_SYNC    1459
 #define MQIACF_NHA_INSTANCE_ROLE       1460
 #define MQIACF_NHA_IN_SYNC_INSTANCES   1461
 #define MQIACF_NHA_TOTAL_INSTANCES     1462
 #define MQIACF_Q_MGR_FS_ENCRYPTED      1463
 #define MQIACF_Q_MGR_FS_IN_USE         1464
 #define MQIACF_Q_MGR_FS_SIZE           1465
 #define MQIACF_SYSP_ZHYPERLINK         1466
 #define MQIACF_CHECKPOINT_COUNT        1468
 #define MQIACF_CHECKPOINT_OPERATIONS   1469
 #define MQIACF_CHECKPOINT_SIZE         1470
 #define MQIACF_NHA_GROUP_BACKLOG       1471
 #define MQIACF_NHA_GROUP_CONNECTED     1472
 #define MQIACF_NHA_GROUP_IN_SYNC       1473
 #define MQIACF_NHA_GROUP_ROLE          1474
 #define MQIACF_NHA_GROUP_STATUS        1475
 #define MQIACF_NHA_INSTANCE_STATUS     1476
 #define MQIACF_NHA_TYPE                1477
 #define MQIACF_LAST_USED               1477
 ...
 #define MQIACH_AUTH_INFO_TYPES         1622
 ...
 #define MQIACH_SPL_PROTECTION          1646
 #define MQIACH_LAST_USED               1646
 ...
 #define MQCACF_APPL_IMMOVABLE_DATE     3209
 #define MQCACF_APPL_IMMOVABLE_TIME     3210
 #define MQCACF_NHA_INSTANCE_NAME       3211
 #define MQCACF_Q_MGR_DATA_PATH         3212
 #define MQCACF_UNIFORM_CLUSTER_NAME    3213
 #define MQCACF_LOG_START_DATE          3214
 #define MQCACF_LOG_START_LSN           3215
 #define MQCACF_LOG_START_TIME          3216
 #define MQCACF_NHA_GROUP_INITIAL_DATE  3217
 #define MQCACF_NHA_GROUP_INITIAL_LSN   3218
 #define MQCACF_NHA_GROUP_INITIAL_TIME  3219
 #define MQCACF_NHA_REPL_ADDRESS        3220
 #define MQCACF_DISK_WRITTEN_LSN        3221
 #define MQCACF_NHA_ACKNOWLEDGED_LSN    3222
 #define MQCACF_NHA_GROUP_ADDRESS       3223
 #define MQCACF_NHA_GROUP_SYNC_ISOTIME  3224
 #define MQCACF_NHA_GROUP_INIT_ISOTIME  3225
 #define MQCACF_NHA_GROUP_LIVE_ISOTIME  3226
 #define MQCACF_NHA_GROUP_LSN           3227
 #define MQCACF_NHA_GROUP_NAME          3228
 #define MQCACF_NHA_GROUP_RECOV_LSN     3229
 #define MQCACF_NHA_GROUP_RECOV_ISOTIME 3230
 #define MQCACF_NHA_SYNC_ISOTIME        3231
 #define MQCACF_LAST_USED               3231
 ...
 #define MQCACH_TEMPORARY_MODEL_Q       3572
 #define MQCACH_TEMPORARY_Q_PREFIX      3573
 #define MQCACH_LAST_USED               3573
 ...
 #define MQGACF_APPL_STATUS             8018
 #define MQGACF_CHANGED_APPLS           8019
 #define MQGACF_ALL_APPLS               8020
 #define MQGACF_APPL_BALANCE            8021
 #define MQGACF_LAST_USED               8021
 ...
 /* Active Options */
 #define MQACTIVE_NO                    0
 #define MQACTIVE_YES                   1

 /* Balance Options */
 #define MQBALANCED_NO                  0
 #define MQBALANCED_YES                 1
 #define MQBALANCED_NOT_APPLICABLE      2
 #define MQBALANCED_UNKNOWN             3

 /* Balance State */
 #define MQBALSTATE_NOT_APPLICABLE      0
 #define MQBALSTATE_LOW                 1
 #define MQBALSTATE_OK                  2
 #define MQBALSTATE_HIGH                3
 #define MQBALSTATE_UNKNOWN             4

 /* Immovable Reasons */
 #define MQIMMREASON_NONE               0
 #define MQIMMREASON_NOT_CLIENT         1
 #define MQIMMREASON_NOT_RECONNECTABLE  2
 #define MQIMMREASON_MOVING             3
 #define MQIMMREASON_APPLNAME_CHANGED   4
 #define MQIMMREASON_IN_TRANSACTION     5
 #define MQIMMREASON_AWAITS_REPLY       6
 #define MQIMMREASON_NO_REDIRECT        7
 ...
 #define MQRQ_REPLICA_ACTIVATED         33
 ...
 #define MQAUTOCLUS_TYPE_NONE           0
 #define MQAUTOCLUS_TYPE_UNIFORM        1

 /* File System Sharing Values */
 #define MQFS_SHARED                    (-1)

 /* File System Encryption Values */
 #define MQFSENC_NO                     0
 #define MQFSENC_YES                    1
 #define MQFSENC_UNKNOWN                2

 /* Log Types */
 #define MQLOGTYPE_CIRCULAR             0
 #define MQLOGTYPE_LINEAR               1
 #define MQLOGTYPE_REPLICATED           2

 /* Native HA Active Connection Values */
 #define MQNHACONNACTV_NO               0
 #define MQNHACONNACTV_YES              1

 /* Native HA Backlog Values */
 #define MQNHABACKLOG_UNKNOWN           (-1)

 /* Native HA Group Connected Values */
 #define MQNHACONNGRP_NO                0
 #define MQNHACONNGRP_YES               1
 #define MQNHACONNGRP_SUSPENDED         2

 /* Native HA Group Roles */
 #define MQNHAGRPROLE_UNKNOWN           0
 #define MQNHAGRPROLE_NOT_CONFIGURED    1
 #define MQNHAGRPROLE_LIVE              2
 #define MQNHAGRPROLE_RECOVERY          3
 #define MQNHAGRPROLE_PENDING_LIVE      4
 #define MQNHAGRPROLE_PENDING_RECOVERY  5

 /* Native HA Instance Roles */
 #define MQNHAROLE_UNKNOWN              0
 #define MQNHAROLE_ACTIVE               1
 #define MQNHAROLE_REPLICA              2
 #define MQNHAROLE_LEADER               3

 /* Native HA In Sync Values */
 #define MQNHAINSYNC_NO                 0
 #define MQNHAINSYNC_YES                1

 /* Native HA Status Values */
 #define MQNHASTATUS_UNKNOWN            0
 #define MQNHASTATUS_NORMAL             1
 #define MQNHASTATUS_CHECKING           2
 #define MQNHASTATUS_SYNCHRONIZING      3
 #define MQNHASTATUS_REBASING           4
 #define MQNHASTATUS_DISK_FULL          5
 #define MQNHASTATUS_DISCONNECTED       6
 #define MQNHASTATUS_PARTITIONED        7

 /* Native HA Types */
 #define MQNHATYPE_INSTANCE             0
 #define MQNHATYPE_GROUP                1
 #define MQNHATYPE_ALL                  (-1)
